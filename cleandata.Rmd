...
```{r}
dataidh= import("https://github.com/WendyAdrianzenRossi/TrabajoE2/blob/main/idh.xlsx?raw=true")
...
```{r}
dataeco=import("https://github.com/WendyAdrianzenRossi/TrabajoE2/blob/main/economia.xlsx?raw=true")
...
```{r}
datademo=import("https://github.com/WendyAdrianzenRossi/TrabajoE2/blob/main/democracia.xlsx?raw=true")
...
```{r}
datagender=import("https://github.com/WendyAdrianzenRossi/TrabajoE2/raw/main/genero.csv")
